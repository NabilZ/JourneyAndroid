 ...
 *
 */
public abstract class JourneyActivityUnitTestCase<T extends Activity>
    ...
    public JourneyActivityUnitTestCase(Class<T> activityClass) {
        ...
        if (!mAttached) {
            ...
            try {
                ...
                ComponentName cn = new ComponentName(
                        getInstrumentation().getTargetContext(), mActivityClass);
